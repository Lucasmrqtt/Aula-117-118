...
model = tensorflow.keras.models.load_model('./static/model_files/chatbot_model.h5')

# Carregue os arquivos de dados
intents = json.loads(open('./static/chatbot_corpus/intents.json').read())
words = pickle.load(open('./static/chatbot_corpus/words.pkl','rb'))
classes = pickle.load(open('./static/chatbot_corpus/classes.pkl','rb'))
